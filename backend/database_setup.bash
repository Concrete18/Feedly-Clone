...
npx sequelize model:generate --name Source_join --attributes feedId:integer,sourceId:integer

# npx sequelize model:generate --name Articles --attributes sourceId:integer,name:string,url:string

npx sequelize model:generate --name Article_join --attributes articleId:integer,sourceId:integer
...
npx sequelize seed:generate --name seed_sources_join

# npx sequelize seed:generate --name seed_articles

npx sequelize seed:generate --name seed_articles_join
